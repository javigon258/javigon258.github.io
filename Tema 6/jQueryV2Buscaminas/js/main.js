let buscaminas = (function() {
  ...
  return {
    ...
    generaMinas: generaMinas,
    actualizaTablero: actualizaTablero,
    descubrirCasillas: descubrirCasillas,
    marcar: marcar,
    contarCasillas: contarCasillas,
    despejar: despejar,
    contarCasillas: contarCasillas,
    compruebaVictoria: compruebaVictoria,
    contarCasillasVictorias: contarCasillasVictorias,
    cuentaBanderas: cuentaBanderas,
    filas: getFilas,
